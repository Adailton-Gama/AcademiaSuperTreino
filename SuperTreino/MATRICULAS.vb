...
Public Class MATRICULAS
    ...
    Sub ShowRecord()
        Try
            ...
            Dim myDeserializedItems = myJsonTool.Deserialize(Of Dictionary(Of String, GerirAlunos))(SRRecord.Body)
            '-------------------------------------------

            '-------------------------------------------To enter a Database (in JSON file format that has been previously converted into an object form) into a Table.
            For Each dictItem As KeyValuePair(Of String, GerirAlunos) In myDeserializedItems
                dtTable.Rows.Add(dictItem.Value.id, dictItem.Value.nome, dictItem.Value.plano, dictItem.Value.ValorPG, dictItem.Value.dtPg, dictItem.Value.telefone, dictItem.Value.observacoes)
            Next
            '-------------------------------------------
    ...
    Private Sub BtnCreateId_Click(sender As Object, e As EventArgs) Handles BtnCreateId.Click
        Try
            ...
            Dim Check_ID = client.Get("GerirAlunos/" + IDresults)
    ...
    Private Sub BtnSave_Click(sender As Object, e As EventArgs) Handles BtnSave.Click
        If BtnSave.Text = "Cadastrar" Then 'Conditions for storing data to the database.
            ...
            Try
                ...
                Dim PD As New GerirAlunos() With
                {
                 .ID = TBID.Text,
                .Nome = TBNome.Text,
                .Plano = TBPlano.Text,
                ...
                Dim save = client.Set("GerirAlunos/" + TBID.Text, PD) 'To save data to Firebase Database.
                ...
                Dim save2 = client.Set("Relatorios/Mensalidade", PD2) 'To save data to Firebase Database.
        ...
        Else 'Conditions for updating data to a database.
            ...
            Try
                ...
                Dim update = client.Update("GerirAlunos/" + TBID.Text, PD) 'To update data to Firebase Database.
                ...
                Dim update2 = client.Update("Relatorios/Mensalidade", PD3) 'To save data to Firebase Database.
    ...
    Private Sub BtnDelete_Click(sender As Object, e As EventArgs) Handles BtnDelete.Click
        ...
        If AllCellsSelected(DGVUserData) = True Then
            Try
                ...
                Dim deleteAll = client.Delete("GerirAlunos") 'To delete data in the Firebase Database
        ...
        Try
            ...
            For Each row As DataGridViewRow In DGVUserData.SelectedRows
                If row.Selected = True Then
                    Dim delete = client.Delete("GerirAlunos/" & row.DataBoundItem(0).ToString)
                End If
            Next
    ...
    Public Sub SomarPagamentos()
        ...
        Next
        LblValPag.Text = "Valor Total Mensal: " & FormatCurrency(Valor)
    End Sub

    Private Sub MATRICULAS_MouseDown(sender As Object, e As MouseEventArgs) Handles Me.MouseDown
        x = Control.MousePosition.X - Me.Location.X
        y = Control.MousePosition.Y - Me.Location.Y
    End Sub

    Private Sub LblRelatorio_Click(sender As Object, e As EventArgs) Handles LblRelatorio.Click
        Dim RelatorioForm As New Relatorio
        For i = 0 To DGVUserData.Rows.Count - 1
            RelatorioForm.DGVRelatorio.Rows.Add(DGVUserData.Rows(i).Cells.Cast(Of DataGridViewCell).Select(Function(c) c.Value).ToArray)
        Next
        MsgBox("Transferecia realizada")
        RelatorioForm.Show()
    End Sub

    Private Sub MATRICULAS_MouseMove(sender As Object, e As MouseEventArgs) Handles Me.MouseMove
