...
Public Class CadAluno
    ...
    Private Sub BtnDelete_Click(sender As Object, e As EventArgs) Handles BtnDelete.Click
        ...
        Dim update2 = client.Update("Relatorios/", PD3) 'To save data to Firebase Database.
        TBValorPG.Text = ""
        '-------------------------------------------
    End Sub
    ...
    Private Sub CadAluno_MouseMove(sender As Object, e As MouseEventArgs) Handles Me.MouseMove
    ...
    Private Sub LblRelatorio_Click(sender As Object, e As EventArgs) Handles LblRelatorio.Click
        Dim RelatorioForm As New RelPag
    ...
    Private Sub TBValorPG_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TBValorPG.KeyPress
        Dim KeyAscii As Short = CShort(Asc(e.KeyChar))
    ...
    Private Sub CadAluno_MouseDown(sender As Object, e As MouseEventArgs) Handles Me.MouseDown
        x = Control.MousePosition.X - Me.Location.X
        y = Control.MousePosition.Y - Me.Location.Y
    End Sub
